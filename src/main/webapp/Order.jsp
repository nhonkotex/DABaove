            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <div class="header__cart__price">User <span></span>_</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    <li><%= c.getName() %><span><%=c.getPrice() %></span></li>
                                
                                </ul>
                                 	<%}
									}
									%>
                                <div class="checkout__order__subtotal">Subtotal <span>${(total>0)?dcf.format(total):0} VNĐ</span></div>
                                <div class="checkout__order__total">Total <span>${(total>0)?dcf.format(total):0} VNĐ</span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
                                ...
                                <a href="tongtien" class="primary-btn">PROCEED TO CHECKOUT</a> 
                                 <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="XLOredr.jsp" class="primary-btn cart-btn">Xem lại đơn hàng</a>
