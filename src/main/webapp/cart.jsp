                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="SearchTH">
                                <div class="hero__search__categories">
                                    All Categories
                                    <span class="arrow_carrot-down"></span>
                                </div>
                                <input type="text"  name="searchKeyword" placeholder="What do yo u need?">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    <td class="shoping__cart__item__close">
                                      <a class="btn btn-sm btn-danger" href="xoakhoiDH?id=<%=c.getId() %>">X</a>
                                    </td>
                                </tr>
	                              	<%}
									}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="product.jsp" class="primary-btn cart-btn">CONTINUE SHOPPING</a>
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Cart Total</h5>
                        <ul>
                            <li>Subtotal <span>$ ${(total>0)?dcf.format(total):0}</span></li>
                            <li>Total <span>$ ${(total>0)?dcf.format(total):0}</span></li>
                        </ul>
                        <a href="Order.jsp" class="primary-btn">PROCEED TO CHECKOUT</a>
                    </div>
                </div>
            </div>
        </div>
