...
<%
	...
	addProductDao dl = new addProductDao(DbCon.getConnetion());
    List<addProduct> quanly = dl.getAllPRD();
...
<body>
   ...
   <div class="image-gallery">
            <header> all users of the shop </header>
        </div>
     ...
     <table class="table table-light">
      ...
      <% } else { %>
            <p>No users found.</p>
        <% } %>
	<!--  hiện ra tất cả sản phẩm của shop  -->
	 <div class="image-gallery">
            <header> Sản Phẩm của apple shop </header>
        </div>
	<table class="table table-light">
			<thead>
				<tr>
			...
			if(!quanrau.isEmpty()) {
				...
				%>
					<tr>
						<td><%=q.getIdR() %></td>
						<td><%=q.getNameR() %></td>
						<td><%=q.getCategoryR() %></td>
						<td><%=q.getPriceR() %></td>
						<td><%=q.getSaleR() %></td>
						<td><%=q.getImageR() %></td>
						<td><%=q.getChitietR() %></td>
						<td><a class="btn btn-sm btn-danger" href="delete-product?id=<%=q.getIdR()%>">Xoá</a></td>
					</tr>
