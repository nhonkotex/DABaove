...
<%@page import="code.dao.addProductDao"%>
<%@page import="code.dao.addProductRDao"%>
<%@page import="code.model.*"%>
...
addProductDao userDao = new addProductDao(DbCon.getConnetion());
List<addProduct> userList = userDao.searchProduct(searchString);

addProductDao te = new addProductDao(DbCon.getConnetion());
List<addProduct> test = te.getAllPRD();

addProductRDao rl = new addProductRDao(DbCon.getConnetion());
List<addProductR> quanrau = rl.getAllPRD();
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="like.jsp"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="cart.jsp"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                        </ul>
                        <div class="header__cart__price">User <span>^-^</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                       ...
                       <% for (addProduct user : userList) { %>
                                <div class="product__item__pic set-bg" data-setbg="img/sp/<%=user.getImage() %>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="addtocart?id=<%= user.getId() %>"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="chitiet?id=<%= user.getId() %>"><%=user.getName() %> </a></h6>
                                    <h5><%=user.getPrice() %></h5>
      ...
      <% } else { %>
        ...
        <% } %>
			...
			if(!quanrau.isEmpty()) {
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__pic set-bg"
                                            ...
                                            data-setbg="img/sp/<%=q.getImageR() %>">
                                            <div class="product__discount__percent"><%=q.getSaleR() %></div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        ...
                                        <div class="product__discount__item__text">
                                            <span><%=q.getCategoryR() %></span>
                                            <h5><a href="#"><%=q.getNameR() %></a></h5>
                                            <div class="product__item__price"><%=q.getPriceR() %> <span>$36.00</span></div>
                                        </div>
				...
				%>
                                   <div class="product__item__pic set-bg" data-setbg="img/sp/<%=q.getImage() %>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="addtocart?id=<%= q.getId() %>"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="chitiet?id=<%= q.getId() %>"><%=q.getName() %> </a></h6>
                                    <h5><%=q.getPrice() %></h5>       
                                </div>
                                 <%}	
									}
			...
			if(!quanrau.isEmpty()) {
				for (addProductR q : quanrau) {		
				%>
                                <div class="product__item__pic set-bg" data-setbg="img/sp/<%=q.getImageR() %>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="addtocartR?id=<%= q.getIdR() %>"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
