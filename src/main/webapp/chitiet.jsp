...
<%@page import="code.dao.ProductDao"%>
            ...
            <ul>
                ...
                <li><a href="product.jsp">Product</a>
                    <ul class="header__menu__dropdown">
                        ...
                        <li><a href="./checkout.html"> Out</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="product__details__text">
                        ...
                        <a href="cart.jsp" class="primary-btn">ADD TO CARD</a>
                        <a href="<%=c.getQuantity()%>" class="heart-icon"><span class="icon_heart_alt"></span></a><br>
                        <a href="OutCT?id=<%=c.getId() %>" class="primary-btn">canner</a>
                        <ul>
            ...
            <div class="row">
				...
				%>
                                ...
                                <div class="product__item__text">
                                    <h6><a href="xemchitiet?id=<%= q.getId() %>"><%=q.getName() %> </a></h6>
                                    <h5><%=q.getPrice() %></h5>
                                          <% 	}
										}
										%>
