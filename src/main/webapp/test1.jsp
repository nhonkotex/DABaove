...
<body>
  <div class="container">
    ...
    <div class="container">
			...
			<form action="<%= request.getContextPath() %>/themProductR" method="post">
                   <p>Tên mặt hàng</p>
					<input type="text" name="nameR" class="form-control" placeholder="vd: Chó pull">
				
						
					<p>Thể loại</p>
					<input type="text" placeholder="vd: thú cưng" class="form-control" name="categoryR" required>
